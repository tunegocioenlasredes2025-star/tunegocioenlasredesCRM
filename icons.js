/* ============================================================
   TNR · Sistema de iconos (Lucide, inline SVG)
   icon('nombre', size) -> string SVG. Reemplaza emojis/glyphs.
   ============================================================ */
(function () {
  'use strict';
  ...
  // Pinta todos los [data-ic] estáticos del HTML (sidebar, topbar, modal)
  function paintStatic(root) {
    (root || document).querySelectorAll('[data-ic]').forEach(el => {
      const size = +el.getAttribute('data-ic-size') || 18;
      el.innerHTML = icon(el.getAttribute('data-ic'), size);
    });
  }

  window.Icons = { icon, paintStatic };
  window.icon = icon; // atajo global para usar en templates
})();
