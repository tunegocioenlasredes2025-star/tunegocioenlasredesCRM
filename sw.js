/* ============================================================
   ...
   ============================================================ */
const CACHE = 'tnr-cache-v32';
const ASSETS = [
  './', './index.html',
  './styles.css?v=32', './icons.js?v=32', './config.js?v=32', './auth.js?v=32',
  './data.js?v=32', './sistema.js?v=32', './recordatorios.js?v=32', './parser.js?v=32',
  './so-vista.js?v=32', './app.js?v=32',
